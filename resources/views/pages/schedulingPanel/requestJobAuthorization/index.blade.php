                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Request Job Authorization List</span>
                            </h3>
                                   ...
                                   <!--begin::Table head-->
									<thead>
                                        ...
                                        <th class="min-w-150px">Status</th>
											<th class="min-w-150px">Pending Request Job Authorizations</th>
											<th class="min-w-140px">Approved Request Job Authorizations</th>
											<th class="min-w-120px">Denied Request Job Authorizations</th>
											<th class="min-w-120px">All Request Job Authorizations</th>
										</tr>
									</thead>
									<!--end::Table head-->
                                    ...
                                    <tbody>
														<tr>
                                                            <td class="text-gray-900 fw-bold text-hover-primary fs-6">Total</td>
															<td>
																<a href="{{route('pending.request')}}" class="text-gray-900 fw-bold text-hover-primary fs-6">2</a>
															</td>
                                                            <td class="text-gray-900 fw-bold text-hover-primary fs-6">3523</td>
                                                            <td class="text-gray-900 fw-bold text-hover-primary fs-6">2141</td>
															<td class="text-gray-900 fw-bold text-hover-primary fs-6">5666</td>
					...
					@csrf<!--begin::Card-->
                        <div class="card mb-7">
                            ...
                            <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Search Request Job Authorization Profile</span>
                            </h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="position-relative w-md-400px me-md-3">
                                        ...
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid ps-10" name="jobId" value="" placeholder="E.x. w-21232" />
                                    </div>
                                    <div class="position-relative w-md-400px me-md-3">
                                        <!--begin::Label-->
