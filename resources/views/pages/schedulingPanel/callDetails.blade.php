                  ...
                  <div class="card mb-xl-10 h-md-100" id="kt_profile_details_view">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="First Name" id="name" name="name" value="Max" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                           ...
                           <div class="col-lg-4 fv-row">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Last Name" id="surname" name="surname" value="Smith" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Cell Phone" id="cell-phone" name="cell-phone" value="000 00 000" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                           ...
                           <div class="col-lg-4 fv-row">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Alternate Phone" id="alternate-phone" name="alternate-phone" value="000 00 000" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                              <span class="fw-bold fs-6 text-muted">000 00 000</span>
                              @endif --}}
                           </div>
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Email" id="email" name="email" value="Max@email.com" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                           ...
                           <div class="col-lg-4 fv-row">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Alternate Phone Extn" id="phone-extn" name="phone-extn" value="" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Address" id="address" name="address" value="Zabjelo 55 Podgorica" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                           ...
                           <div class="col-lg-4 fv-row">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Unit" id="unit" name="unit" value="" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                              <span class="fw-semibold text-gray-800 fs-6"></span>
                              @endif --}}
                           </div>
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="City:" id="city" name="city" value="Brampton" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                           ...
                           <div class="col-lg-4 fv-row">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Province" id="province" name="province" value="ON" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Postal Code:" id="postal-code" name="postal-code" value="L6R 3G4" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                           ...
                           <div class="col-lg-4 fv-row">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Country:" id="country" name="country" value="Canada" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                     ...
                     <div class="card-body row">
                        <div class="col-lg-12">
                           <div class="row mb-4 align-items-center">
                              ...
                              <div class="col-lg-3">
                                 ...
                                 <input type="text" class="form-control" placeholder="Current Job Status" id="job_status" name="job_status" value="062213993135" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                           <div class="row mb-4 align-items-center">
                              <label class="col-lg-3 fw-bold text-gray-800" for="job_id" {{ $edit ? 'style=padding:11px;' : '' }}>Admin Panel Job ID:</label>
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="Admin Panel Job ID" id="job_id" name="job_id" value="w-12232" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                              <label class="col-lg-3 fw-bold text-gray-800" for="hcp_invoice"  {{ $edit ? 'style=padding:11px;' : '' }}>HCP Invoice:</label>
                              <div class="col-lg-3">
                                 {{-- <span class="fw-bold fs-6 text-muted">062213993135</span> --}}
                                 <input type="text" class="form-control" placeholder="HCP Invoice" id="hcp_invoice" name="hcp_invoice" value="062213993135" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                           <div class="row mb-4 align-items-center">
                              ...
                              <div class="col-lg-3">
                                 {{-- <span class="fw-bold fs-6 text-muted">062213993135</span> --}}
                                 <input type="text" class="form-control" placeholder="B2B/ Warranty Reference ID" id="warranty_reference_id" name="warranty_reference_id" value="062213993135" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                              ...
                              <div class="col-lg-3">
                                 ...
                                 <input type="text" class="form-control" placeholder="Source (B2C, B2B, Warranty)" id="source" name="source" value="Warranty" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                        </div>
                        <div class="separator separator-dashed mb-9"></div>
                        <div class="col-lg-12">
                           ...
                           <div class="row mb-4 align-items-center">
                              ...
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="Company Name" id="company_name" name="company_name" value="SQUARETRADE" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                              <label class="col-lg-3 fw-bold text-gray-800" for="ap_phone" {{ $edit ? 'style=padding:11px;' : '' }}>AP Phone:</label>
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="AP Phone" id="ap_phone" name="ap_phone" value="1-857-254-1169" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                           <div class="row mb-4 align-items-center">
                              <label class="col-lg-3 fw-bold text-gray-800" for="poc_phone" {{ $edit ? 'style=padding:11px;' : '' }}>POC Phone:</label>
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="POC Phone" id="poc_phone" name="poc_phone" value="062213993135" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                              <label class="col-lg-3 fw-bold text-gray-800" for="ap_phone_extn" {{ $edit ? 'style=padding:11px;' : '' }}>AP Phone Extn:</label>
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="AP Phone Extn" id="ap_phone_extn" name="ap_phone_extn" value="" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                           <div class="row mb-4 align-items-center">
                              <label class="col-lg-3 fw-bold text-gray-800" for="poc_phone_extn" {{ $edit ? 'style=padding:11px;' : '' }}>POC Phone Extn:</label>
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="POC Phone Extn" id="poc_phone_extn" name="poc_phone_extn" value="2" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                              <label class="col-lg-3 fw-bold text-gray-800" for="company_ap_email" {{ $edit ? 'style=padding:11px;' : '' }}>Company AP Email:</label>
                              <div class="col-lg-3">
                                 <input type="email" class="form-control" placeholder="Company AP Email" id="company_ap_email" name="company_ap_email" value="tech_compliance@squaretrade.com" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                           <div class="row mb-4 align-items-center">
                              <label class="col-lg-3 fw-bold text-gray-800" for="company_poc_email" {{ $edit ? 'style=padding:11px;' : '' }}>Company POC Email:</label>
                              <div class="col-lg-3">
                                 <input type="email" class="form-control" placeholder="Company AP Email" id="company_poc_email" name="company_poc_email" value="appliance_team@squaretrade.com" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                              ...
                              <div class="col-lg-3">
                                 <input type="text" class="form-control" placeholder="Company Desired  Markup for invoices" id="company_desired_markup_invoices" name="company_desired_markup_invoices" value="0%" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-xxl-12">
                  <div class="card mb-xl-10" id="kt_profile_details_view">
                     ...
                     <div class="card-body row">
                        <div class="col-lg-6 border-end">
                           ...
                           <div class="row mb-4 align-items-center">
                              ...
                              <div class="col-lg-3 fv-row">
                                 {{-- @if($edit) --}}
                                 <input type="text" class="form-control" placeholder="Type of Product:" id="type-of-product" name="type-of-product" {{ $edit ? '' : 'disabled="disabled"' }}>
                                 {{-- @else
                           ...
                           <div class="row mb-4 align-items-center">
                              ...
                              <div class="col-lg-3 fv-row">
                                 {{-- @if($edit) --}}
                                 <input type="text" class="form-control" placeholder="Serial Number:" id="serial-number" name="serial-number" value="N/a" {{ $edit ? '' : 'disabled="disabled"' }}>
                                 {{-- @else
                        ...
                        <div class="col-lg-6">
                           <div class="row mb-4 align-items-center">
                              <label class="col-lg-3 fw-bold text-gray-800" for="urgency-level" {{ $edit ? 'style=padding:11px;' : '' }}>Urgency Level:</label>
                              <div class="col-lg-4 fv-row">
                                 {{-- @if($edit) --}}
                           ...
                           <div class="row mb-4 align-items-center">
                              <label class=" fw-semibold text-gray-800 mb-1" for="problem-description" {{ $edit ? 'style=padding:11px;' : '' }}>Problem Description:</label>
                              <div class="col-lg-7 fv-row">
                                 {{-- @if($edit) --}}
                                 <textarea type="text" class="form-control" placeholder="Problem Description:" id="problem-description" name="problem-description" {{ $edit ? '' : 'disabled="disabled"' }}>Range won't heat properly, the burner is barely heating up</textarea>
                                 {{-- @else
                  ...
                  <div class="card mb-xl-10" id="kt_profile_details_view">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              {{-- @if($edit) --}}
                              <input type="text" class="form-control" placeholder="Total Parts:" id="total-parts" name="total-parts" value="0" {{ $edit ? '' : 'disabled="disabled"' }}>
                              {{-- @else
                  ...
                  <div class="card mb-xl-10" id="kt_profile_details_view">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-4">
                              <input type="text" class="form-control" placeholder="Assigned Tech:" id="assigned_tech" name="assigned_tech" {{ $edit ? '' : 'disabled="disabled"' }}>
                           </div>
                        </div>
                        @endif
                     </div>
                     ...
                     <div class="card-body row">
                        <div class="col-lg-3 border-end">
                           ...
                           <div class="row mb-4 align-items-center">
                              ...
                              <div class="col-lg-6">
                                 <input type="text" class="form-control" placeholder="Current Job Stage" id="current_job_stage" name="current_job_stage" value="Job Rejected" {{ $edit ? '' : 'disabled="disabled"' }}>
                              </div>
                           </div>
                           <div class="row mb-4 align-items-center">
                     ...
                     <div class="card-body">
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="position-relative d-flex align-items-center col-lg-3">
                              <i class="ki-duotone ki-calendar-8 fs-2 position-absolute mx-4"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></i>
                              <input class="form-control form-control-solid ps-12 flatpickr-input" value="2024/01/19" placeholder="Select schedule date" name="new_schedule_date" id="new_schedule_date" type="text" readonly="readonly" {{ $edit ? '' : 'disabled="disabled"' }}>
                           </div>
                  ...
                  <div class="card mb-xl-10 h-md-100" id="kt_profile_details_view">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-5">
                              <input type="text" class="form-control" placeholder="Admin Panel Job ID" id="current_job" name="current_job" value="w-121212" {{ $edit ? '' : 'disabled="disabled"' }}>
                           </div>
                        </div>
                        <div class="row mb-4 align-items-center">
                  ...
                  <div class="card mb-xl-10 h-md-100" id="kt_profile_details_view">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center">
                           ...
                           <div class="col-lg-9">
                              <textarea type="text" class="form-control" rows="3" id="important_note" placeholder="Important Note:" name="important_note" {{ $edit ? '' : 'disabled="disabled"' }}>Only one approved "Job Authorization Request" is allowed per job. Upon approval, it will appear on the "Next Related Job" and will be facilitated on the "In Progress Jobs" section.</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
